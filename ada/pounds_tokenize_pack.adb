...
procedure toarray (total_words: out Integer; syllables: out Integer; sentences: out Integer; file: in String) is
...
begin
   ...
   Ada.Text_IO.Open (File => In_File, Mode => Ada.Text_IO.In_File, Name => file);
